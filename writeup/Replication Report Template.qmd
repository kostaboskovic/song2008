...
The design is so simple that I don't think there are confounds. The fact that they only posed two questions (one control, one distorted) limits generalizability.
